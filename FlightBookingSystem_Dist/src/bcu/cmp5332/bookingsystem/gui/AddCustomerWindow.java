...
public class AddCustomerWindow extends JFrame implements ActionListener {
	...
	/**
     * Creates a new text field, customer's name, for user input in a graphical user interface (GUI)
     */
    private JTextField custNameText = new JTextField();
    /**
     * Creates a new text field, phone number, for user input in a graphical user interface (GUI)
     */
    private JTextField custPhoneText = new JTextField();
    /**
     * Creates a new text field, email, for user input in a graphical user interface (GUI)
     */
